...
class RetinaNetDetector(IObjectDetection):
    ...
    def train(self, framework_path = None, n_gpus = 1):
        ...
        os.system(command)
        os.system('retinanet-convert-model ' +os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, "models","resnet50_csv_05.h5")  + ' ' +os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, "models",'output.h5'))
