...
class RetinaNetDetector(IObjectDetection):
    ...
    def train(self, framework_path = None, n_gpus = 1):
        ...
        os.rename(os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, "models","resnet50_csv_5.h5"),os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, "models","resnet50_" + self.DATASET_NAME + ".h5"))
    ...
    def evaluate(self):
        ...
        retinanetPredict = RetinanetPredictor(
            os.path.join(self.OUTPUT_PATH, self.DATASET_NAME,"models", "resnet50_" + self.DATASET_NAME + "h5"),
