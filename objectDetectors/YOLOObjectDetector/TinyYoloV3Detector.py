...
class TinyYoloV3Detector(DarknetAbstract):
    ...
    def train(self, framework_path = None, n_gpus = 1):
        ...
        confi = os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, self.DATASET_NAME+"TinyTrain.cfg")
    ...
    def evaluate(self, framework_path = None):
        tinyyoloPredict = DarknetPredict(
            os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, self.DATASET_NAME + "train_finalTinyYolo.weights"),
