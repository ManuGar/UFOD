...
class TinyYoloV3Detector(DarknetAbstract):
    ...
    #     confi =  self.DATASET_NAME+"TinyTrain.cfg"
    ...
    #     shutil.move(os.path.join(self.OUTPUT_PATH, self.DATASET_NAME, self.DATASET_NAME + "TinyTrain_final.weights"),
    ...
    def evaluate(self):
        tinyyoloPredict = DarknetPredict(
            ...
            os.path.join(self.OUTPUT_PATH, self.DATASET_NAME+"_"+self.model,self.DATASET_NAME+"_"+self.model + ".cfg"))
