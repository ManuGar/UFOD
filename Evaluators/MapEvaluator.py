...
class MapEvaluator(IEvaluator):
    ...
    def evaluate(self, dataset_name, dataset_path):
        ...
        for image in image_paths:
            ...
            anno_splited = os.path.join(dataset_path, "test", "Annotations", name + ".xml")
        ...
        os.system("find `pwd`"+ aux_path + "/labels -name '*.txt' > " + aux_path + "/test.txt")
        os.system("../map/darknet detector compare " + os.path.join(aux_path,"test.txt") + " " + os.path.join(aux_path,"classes.names"))
